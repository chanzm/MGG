...
<link rel="stylesheet" type="text/css" href="tablepel.css">
...
<div class="container">
    <div class="row" style="background-color:#e1e7f2">
        ...
        <div style="padding: 25px 0px 25px 100px">
           <h1 style="font-size: 35px">Daftar Pelanggaran</h1>
        </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Pelanggaran</h3>
                  </div>
                              ...
                              <div class="dropdown">
                                <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">
                                 ...
                                 <div class="dropdown-menu">
                                  <a class="dropdown-item" href="#">Ringan</a>
                                  <a class="dropdown-item" href="#">Sedang</a>
                                  <a class="dropdown-item" href="#">Berat</a>
                                </div>
                              </div>
                            </td>
                            <td>.............</td>
...
<div id="id01" class="modal">
  ...
  <!--     <img src="wes.jpg" alt="jilbab" class="jilbab"> -->
    ...
    <div class="container jumbotron">
      <h2 style="padding-bottom: 20px"> Input Pelanggaran </h2>
...
<div id="id02" class="modal">
  ...
  <!--     <img src="wes.jpg" alt="jilbab" class="jilbab"> -->
    ...
    <div class="container jumbotron">
      <h2 style="padding-bottom: 20px"> Edit Pelanggaran </h2>
